...
def app():
    ...
    st.write("# Total de Mujeres Indígenas")
    st.write(total, " es el número de Mujeres Indígenas que hacen parte de la investigacíón")


    # SELECTING  the Resguardo 
    resguardo = st.multiselect("SELCCIONE UN RESGUARDO", df['3_En_que_resguardo_N'].unique())
